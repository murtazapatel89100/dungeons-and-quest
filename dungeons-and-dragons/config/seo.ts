...
export const pageMetadata = {
  ...
  charactersCustom: {
    ...
    description:
      "Build your D&D hero from scratch. Choose your race, class, background, and roll stats with our interactive step-by-step character creator.",
  },
  charactersPregen: {
    title: "Pre-Generated Characters",
    description:
      "Jump right into the action with our roster of balanced, ready-to-play level 1 characters for your next D&D campaign.",
  },
  charactersQuick: {
    title: "Quick Hero Generator",
    description:
      "Instantly generate a complete, randomized level 1 D&D character with full stats, spells, and backstory.",
  },
  charactersSheet: {
