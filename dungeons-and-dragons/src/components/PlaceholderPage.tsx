  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-12 bg-[#111827]/80 backdrop-blur-md rounded-sm border border-[#D4AF37]/30 shadow-[0_0_30px_rgba(109,40,217,0.2)]">
        <h1 className="text-4xl md:text-5xl font-heading text-[#F9FAFB] uppercase tracking-widest mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
          {title}
        </h1>
        <p className="text-[#9CA3AF] font-sans text-base md:text-lg">
          This section of the grimoire is currently sealed.
        </p>
        <div className="mt-8">
          <Link
            href="/"
            className="inline-block px-6 py-2 border border-[#D4AF37] text-[#D4AF37] font-heading uppercase tracking-wider hover:bg-[#D4AF37]/10 transition-colors duration-300 shadow-[0_0_10px_rgba(212,175,55,0.2)]"
          >
            Return to Map
          </Link>
        </div>
