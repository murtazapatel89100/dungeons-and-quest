    ...
    <section className="py-24 bg-[#111827] relative border-t border-[#1F2937]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            At a glance, see which path offers the mechanics and social
        ...
        >
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[#1F2937]">
              {experienceData.comparisonData.map((stat, _index) => (
                <tr
                  key={stat.id}
                ...
                >
                  ...
                  <td className={`p-6 ${scoreColors[stat.combat]}`}>
                    {stat.combat}
                  </td>
                  <td className={`p-6 ${scoreColors[stat.roleplay]}`}>
                    {stat.roleplay}
                  </td>
                  <td className={`p-6 ${scoreColors[stat.beginnerFriendly]}`}>
                    {stat.beginnerFriendly}
                  </td>
                </tr>
              ))}
            </tbody>
