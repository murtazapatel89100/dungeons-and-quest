...
import { BookOpen, ExternalLink, Map as MapIcon, Users } from "lucide-react";
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-[#9CA3AF] max-w-2xl mx-auto">
              Not sure where to begin? Here are the best starting points based
              on your gaming background.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#111827] border border-[#1F2937] p-8 rounded-2xl relative">
              ...
              <p className="text-[#D1D5DB] mb-6">
                Start with <strong>Baldur's Gate 3</strong>. It perfectly adapts
                D&D 5th Edition rules into a visual, automated system, making it
                the best interactive tutorial available.
              </p>
              <div className="bg-[#0B0F1A] p-4 rounded-lg border border-[#1F2937]">
                <span className="text-sm text-[#9CA3AF] uppercase tracking-wider block mb-2">
                  Next Step
                </span>
                <span className="text-[#F9FAFB]">
                  Join a beginner-friendly online campaign once you understand
            ...
            <div className="bg-[#111827] border border-[#1F2937] p-8 rounded-2xl relative">
              ...
              <p className="text-[#D1D5DB] mb-6">
                Look for <strong>Roleplay Communities</strong> or "Story-heavy"
                campaigns. These games prioritize acting and dialogue over
                grid-based combat math.
              </p>
              <div className="bg-[#0B0F1A] p-4 rounded-lg border border-[#1F2937]">
                <span className="text-sm text-[#9CA3AF] uppercase tracking-wider block mb-2">
                  Next Step
                ...
                <span className="text-[#F9FAFB]">
                  Create a character backstory and practice reading the rules
                  for skill checks.
                </span>
              </div>
            </div>
            ...
            <div className="bg-[#111827] border border-[#1F2937] p-8 rounded-2xl relative">
              ...
              <p className="text-[#D1D5DB] mb-6">
                Dive into <strong>Tactical Campaigns</strong>. Look for
                "Mega-Dungeon" or "Combat Heavy" tags when searching for groups
                to play with.
              </p>
              <div className="bg-[#0B0F1A] p-4 rounded-lg border border-[#1F2937]">
                <span className="text-sm text-[#9CA3AF] uppercase tracking-wider block mb-2">
                ...
                <span className="text-[#F9FAFB]">
                  Study class optimization and combat positioning rules in the
                  Basic Rules.
                </span>
              </div>
            </div>
        ...
        <div>
          <div className="text-center mb-16">
            ...
            <p className="text-[#9CA3AF]">
              While our site provides the essential tools and rules to get
              started, these platforms offer massive external ecosystems for
              advanced play.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {experienceData.resources.map((resourceGroup) => {
              const Icon =
                resourceGroup.category === "Learn"
                  ? BookOpen
                  : resourceGroup.category === "Play"
                    ? Users
                    : MapIcon;
