  ...
  return (
    <section className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto mt-10">
        ...
        >
          <div className="p-3 md:p-4 rounded-full bg-[#111827]/80 border border-[#10B981]/30 shadow-[0_0_40px_rgba(16,185,129,0.15)] relative">
            <div className="absolute inset-0 bg-[#10B981]/20 rounded-full blur-md animate-pulse" />
            <Scroll className="w-8 h-8 md:w-12 md:h-12 text-[#10B981] relative z-10" />
          </div>
        </motion.div>
