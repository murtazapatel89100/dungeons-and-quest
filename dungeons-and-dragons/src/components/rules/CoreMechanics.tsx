      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 px-4">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6 relative z-10">
            ...
            <h3 className="font-['Cinzel'] text-3xl text-[#F9FAFB]">{advantage.title}</h3>
          </div>
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6 relative z-10">
            ...
            <h3 className="font-['Cinzel'] text-3xl text-[#F9FAFB]">{dc.title}</h3>
          </div>
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-[#1F2937]/50 text-[#F9FAFB] font-['Cinzel'] uppercase">
                <tr>
                  ...
                  <th className="px-6 py-4 font-semibold text-right">DC Target</th>
                </tr>
              </thead>
              <tbody>
                {dc.table.map((row, idx) => (
                  <tr key={idx} className="border-b border-[#1F2937] last:border-0 hover:bg-[#1F2937]/30 transition-colors">
                    <td className="px-6 py-3 text-[#9CA3AF]">{row.difficulty}</td>
                    <td className="px-6 py-3 text-[#FBBF24] font-bold text-right font-mono">{row.dc}</td>
                  </tr>
                ))}
              </tbody>
            </table>
