...
const SLIDES = [
  {
    id: 1,
    image: "https://images.unsplash.com/photo-1724355198376-05df48bd251a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXJrJTIwZmFudGFzeSUyMGRyYWdvbiUyMGNhc3RsZXxlbnwxfHx8fDE3NzQ1NDU2ODB8MA&ixlib=rb-4.1.0&q=80&w=1080",
    title: "Begin Your Adventure",
    subtitle: "Learn the fundamentals of Dungeons & Dragons and step into a world of imagination",
    cta: "Start Learning",
    path: "/learn",
  },
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1627732922021-e73df99d192e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpZXZhbCUyMHdhcnJpb3IlMjBmYW50YXN5JTIwc3dvcmR8ZW58MXx8fHwxNzc0NTQ1Njg0fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  {
    id: 3,
    image: "https://images.unsplash.com/photo-1634409884980-a30da0b2b010?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWdpYyUyMHNwZWxsJTIwd2l6YXJkJTIwZmFudGFzeXxlbnwxfHx8fDE3NzQ1NDU2ODh8MA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  {
    id: 4,
    image: "https://images.unsplash.com/photo-1593718069814-7f870c700c6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYW50YXN5JTIwbWFnaWNhbCUyMGl0ZW1zJTIwdG9vbHN8ZW58MXx8fHwxNzc0NTQ2MTQyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    title: "Arcane Instruments",
    subtitle: "Equip yourself with powerful tools to manage campaigns, track initiative, and generate encounters",
    cta: "Discover Tools",
    path: "/tools",
  },
];
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 mt-16">
            ...
            >
              ...
              <button 
                ...
                onClick={() => window.location.href = SLIDES[currentIndex].path}
              >
