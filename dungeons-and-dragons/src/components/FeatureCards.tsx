...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Discover how you prefer to experience the game.",
    icon: Compass,
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {FEATURES.map((feature, index) => (
            <Link key={feature.title} href={feature.path} className="h-full">
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className={`relative h-full bg-[#111827] border ${feature.border} p-8 rounded-sm group overflow-hidden transition-all duration-300 ${feature.shadow}`}
              >
                <div
