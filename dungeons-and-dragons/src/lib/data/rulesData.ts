  ...
  combat: [
    {
      ...
      items: [
        {
          name: "Half Cover",
          desc: "+2 bonus to AC and Dexterity saving throws.",
          detail:
        ...
        },
        {
          ...
          desc: "+5 bonus to AC and Dexterity saving throws.",
          detail:
        ...
        {
          name: "Total Cover",
          desc: "Can't be targeted directly by an attack or a spell.",
          detail:
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Elemental",
          desc: "Acid, Cold, Fire, Lightning, and Thunder.",
        },
        {
          name: "Arcane/Divine",
          desc: "Force, Necrotic, Poison, Psychic, and Radiant.",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Roll a d20",
          desc: "If the roll is 10 or higher, you succeed. Otherwise, you fail. A success or failure has no effect by itself.",
        },
        {
          name: "Three Strikes",
          desc: "On your third success, you become stable. On your third failure, you die.",
        },
        {
          name: "Rolling 1 or 20",
          desc: "When you make a death saving throw and roll a 1 on the d20, it counts as two failures. If you roll a 20, you regain 1 hit point.",
        },
      ],
    },
  ] as RuleSection[],
      ...
      types: [
        {
          ...
          benefits:
            "A character can spend one or more Hit Dice to regain hit points. Some class features (like Warlock spell slots or Fighter Action Surge) are also regained.",
        },
        {
          name: "Long Rest",
          duration: "At least 8 hours",
          benefits:
            "A character regains all lost hit points and regains spent Hit Dice, up to a number of dice equal to half of the character's total number of them. Also restores all spell slots and long-rest abilities.",
        },
      ],
    },
    vision: {
      ...
      description:
        "The most fundamental tasks of adventuring—noticing danger, finding hidden objects, hitting an enemy in combat—rely heavily on a character's ability to see.",
      categories: [
        {
          name: "Lightly Obscured",
          desc: "Creatures have disadvantage on Wisdom (Perception) checks that rely on sight. Examples: dim light, patchy fog, moderate foliage.",
        },
        {
          name: "Heavily Obscured",
          desc: "A creature suffers from the blinded condition. Examples: darkness, opaque fog, dense foliage.",
        },
        {
          name: "Darkvision",
          desc: "Many creatures have Darkvision, allowing them to see in dim light within a specified radius as if it were bright light, and in darkness as if it were dim light (can't discern color in darkness).",
        },
      ],
    },
    hazards: {
      ...
      description:
        "Adventurers face dangers far beyond monsters. The environment itself can be deadly.",
      types: [
        {
          name: "Falling",
          desc: "A creature takes 1d6 bludgeoning damage for every 10 feet it falls, to a maximum of 20d6. The creature lands prone, unless it avoids taking damage.",
        },
        {
          name: "Suffocating",
          desc: "A creature can hold its breath for a number of minutes equal to 1 + its Constitution modifier (minimum of 30 seconds). When a creature runs out of breath, it can survive for a number of rounds equal to its Constitution modifier before it drops to 0 HP and is dying.",
        },
      ],
    },
  },
